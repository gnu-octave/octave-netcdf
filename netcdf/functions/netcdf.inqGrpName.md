...
<dt class="deftypefn def-line" id="index-netcdf_002einqGrpName_0028ncid_0029"><span><code class="def-type"><var class="var">name</var> =</code> <strong class="def-name">netcdf.inqGrpName(<var class="var">ncid</var>)</strong></span></dt>
