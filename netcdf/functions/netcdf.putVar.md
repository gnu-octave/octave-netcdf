...
<dt class="deftypefn def-line" id="index-netcdf_002eputVar"><span><strong class="def-name">netcdf.putVar</strong> <code class="def-code-arguments">(<var class="var">ncid</var>,<var class="var">varid</var>,<var class="var">data</var>)</code></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-netcdf_002eputVar-1"><span><strong class="def-name">netcdf.putVar</strong> <code class="def-code-arguments">(<var class="var">ncid</var>,<var class="var">varid</var>,<var class="var">start</var>,<var class="var">data</var>)</code></span></dt>
