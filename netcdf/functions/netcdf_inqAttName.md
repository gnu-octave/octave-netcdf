...
title: "Netcdf Toolkit - netcdf_inqAttName"
category: "Test function"
func_name: "netcdf_inqAttName"
navigation:
- id: "overview"
  name: "Overview"
  url: "/index"
...
<dt class="deftypefn def-line" id="index-netcdf_005finqAttName"><span class="category-def">Loadable Function: </span><span><code class="def-type"><var class="var">name</var> =</code> <strong class="def-name">netcdf_inqAttName</strong> <code class="def-code-arguments">(<var class="var">ncid</var>,<var class="var">varid</var>,<var class="var">attnum</var>)</code><a class="copiable-link" href="#index-netcdf_005finqAttName"></a></span></dt>
