...
<dt class="deftypefn def-line" id="index-netcdf_002eendDef"><span class="category-def">: </span><span><strong class="def-name">netcdf.endDef</strong> <code class="def-code-arguments">(<var class="var">ncid</var>)</code><a class="copiable-link" href="#index-netcdf_002eendDef"></a></span></dt>
