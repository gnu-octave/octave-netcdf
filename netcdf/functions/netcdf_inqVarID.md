...
title: "Netcdf Toolkit - netcdf_inqVarID"
category: "Test function"
func_name: "netcdf_inqVarID"
navigation:
- id: "overview"
  name: "Overview"
  url: "/index"
...
<dt class="deftypefn def-line" id="index-netcdf_005finqVarID"><span class="category-def">Loadable Function: </span><span><code class="def-type"><var class="var">varid</var> =</code> <strong class="def-name">netcdf_inqVarID</strong> <code class="def-code-arguments">(<var class="var">ncid</var>,<var class="var">name</var>)</code><a class="copiable-link" href="#index-netcdf_005finqVarID"></a></span></dt>
