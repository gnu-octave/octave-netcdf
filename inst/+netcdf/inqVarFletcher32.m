...
## Determines the checksum settings of the variable with the id @var{varid} in the data set @var{ncid}.
##
## If fletcher32 checksums is turned on for this variable, then @var{checksum} is the string "FLETCHER32".
